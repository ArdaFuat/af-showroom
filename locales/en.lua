...
Locales['en'] = {
    ...
    ['ui_type'] = 'Type',
    ['ui_seats'] = 'Seats',
    ['ui_drivetrain'] = 'Drivetrain',
    ['ui_top_speed'] = 'Top Speed',
    ['ui_mass'] = 'Mass',
    ['ui_dimensions'] = 'Dimensions',
    ['ui_lap_time'] = 'Lap Time',
    ['ui_race_tier'] = 'Race Tier',
    ...
    ['category_Van'] = 'Van',
    ['category_Compacts'] = 'Compacts',
    ['category_Coupes'] = 'Coupes',
    ['category_Motorcycles'] = 'Motorcycles',
    ['category_Off-Road'] = 'Off-Road',
    ['category_SUVs'] = 'SUVs',
    ['category_Supers'] = 'Supers',
    ['category_Sports'] = 'Sports',
    ['category_Sports Classics'] = 'Sports Classics',
    ['category_Sedans'] = 'Sedans',
    ['category_Vans'] = 'Vans',
